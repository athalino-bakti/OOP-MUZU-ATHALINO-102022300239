    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException("data dan priority yang dipilih tida boleh kosong");
            }

            if (dueDatePicker.getValue().isBefore(LocalDate.now())) {
                // TODO: Throw new InvalidDateException dengan pesan yang sesuai
                throw new  InvalidDateException("pilih tanggal sebelum hari ini");
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("tidak ada tabel yang dipilih");
